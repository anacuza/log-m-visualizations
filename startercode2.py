...
class Starter(PygameHelper):
    ...
    def mouseMotion(self, buttons, pos, rel):
        if 100 <= pos[0] <= 500 and 100 <= pos[1] <= 500:
            ...
            #1st polygon for perpendicular fold
            #pp12_w = strc2_w + 200 * cos(theta_3)
            #pp12_h = strc2_h - 200 * sin(theta_3)
            #pp11_w = pp12_w + 200 * cos(pi / 6)
            #pp11_h = pp12_h - 200 * sin(pi / 6)
            #perpPlane1List = [[strc2_w,strc2_h], [strc1_w, strc1_h], [pp11_w, pp11_h], [pp12_w, pp12_h]]
            #pygame.draw.polygon(self.screen, MAROON, perpPlane1List, 2)
